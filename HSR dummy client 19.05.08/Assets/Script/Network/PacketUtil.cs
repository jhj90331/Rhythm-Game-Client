...
namespace DummyClient
{
    ...
    public static class PacketUtil
    {
		...
		public static void encode(MemoryStream packet, float value)
		{
			packet.Write(BitConverter.GetBytes(value), 0, sizeof(float));
		}
		...
		public static float decodefloat(Byte[] data, ref Int32 offset)
		{
