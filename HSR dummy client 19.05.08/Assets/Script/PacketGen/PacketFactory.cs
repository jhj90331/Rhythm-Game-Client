    ...
    public static class PacketFactory
    {
        public static PacketInterface getPacket(Int64 packetType) 
        {
            switch ((PacketType)packetType)
            {
				...
				case PacketType.E_C_REQ_GAME_NAME: return new PK_C_REQ_GAME_NAME();
				case PacketType.E_C_REQ_ENEMY_NOTEHIT: return new PK_C_REQ_ENEMY_NOTEHIT();
				case PacketType.E_C_REQ_GAME_CONNECT: return new PK_C_REQ_GAME_CONNECT();
				case PacketType.E_S_ANS_GAME_CONNECT: return new PK_S_ANS_GAME_CONNECT();
				case PacketType.E_C_REQ_GAME_CONNECT_CANCEL: return new PK_C_REQ_GAME_CONNECT_CANCEL();
				case PacketType.E_C_REQ_EXIT_GAME: return new PK_C_REQ_EXIT_GAME();
